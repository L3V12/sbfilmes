    ...
    <div id="templatemo_main">
        ...
        <div id="content">
        	...
        	<table width="700px" cellspacing="0" cellpadding="5">
                      ...
                      <tr>
                        	<td><img src="images/product/10.jpg" alt="image 02" /> </td>
                            <td>Imortais</td> 
                   	  	  <td align="center"><input type="text" value="1" style="width: 20px; text-align: right" />  </td>
                            <td align="right">$300 </td>
                            <td align="right">$300 </td>
                            <td align="center"> <a href="#"><img src="images/remove_x.gif" alt="remove" /><br />Deletar</a>  </td>
                            <td align="center"> <a href="#"><img src="images/loading.gif" alt="remove" /><br />Atualizar Filme</a> </td>
						</tr>
                      <tr>
            ...
            <tr>
                        	<td><img src="images/product/03.jpg" alt="image 01" /></td> 
                        	<td>Hora da Escuridão</td> 
                            <td align="center"><input type="text" value="1" style="width: 20px; text-align: right" /> </td>
                        ...
                        <tr>
                            ...
                            <td align="right" style="background:#ccc; font-weight:bold">$540 </td>
