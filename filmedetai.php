...
<div id="newsletter">
      ...
      <div class="col col_13 no_margin_right">
                <table>
                    <tr>
                        <td height="30" width="160">Preço:</td>
                        <td>$100</td>
                    </tr>
                    <tr>
                        <td height="30">Disponibilidade:</td>
                        <td>Em estoque</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td height="30">Fabricante:</td>
                        <td>Marvel</td>
                    </tr>
                    <tr>
                        <td height="30">Categoria:</td>
                        <td>Para maiores de 18 anos</td>
                    </tr>
                    <tr><td height="30">Quantidade</td><td><input type="text" value="1" style="width: 20px; text-align: right" /></td></tr>
                </table>
                <div class="cleaner h20"></div>
            ...
            <h5><strong>Descriçaõ do Filme</strong></h5>
            <p>O impiedoso rei Hyperion busca o arco de Épiro para dominar o mundo e destruir os deuses. O único que pode detê-lo é Theseus,
             um corajoso jovem escolhido por Zeus. Com a ajuda da sacerdotisa Phaedra, ele comandará essa batalha épica..</p>	
            
            <div class="cleaner h50"></div>
            
            <h4>Outros produtos</h4>
        	<div class="col col_14 product_gallery">
            	<a href="alugarfilme.php"><img src="images/product/01.jpg" alt="Product 01" border="0" /></a>
              <h3>Nome do Filme</h3>
                <p class="product_price">R$ 100</p>
                <a href="alugarfilme.php" class="add_to_cart">Alugar</a>            </div>        	
        <div class="col col_14 product_gallery">
            	<a href="alugarfilme.php"><img src="images/product/02.jpg" alt="Product 02" /></a>
        <h3>Nome do Filme</h3>
              <p class="product_price">R$ 200</p>
                <a href="alugarfilme.php" class="add_to_cart">Alugar</a>            </div>        	
      <div class="col col_14 product_gallery no_margin_right"><a href="productdetail.html"><a href="productdetail.html"><a href="productdetail.html"></a><a href="alugarfilme.php"><img src="images/product/03.jpg" alt="Product 03" width="151" height="198" /></a></a></a>
        <h3>Nome do Filme</h3>
        <p class="product_price">R$ 120</p>
                <a href="alugarfilme.php" class="add_to_cart">Alugar</a>            </div>
<a href="filmes.php" class="more float_r">Ver todosl</a>
